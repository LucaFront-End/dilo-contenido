...
export default function CoverSlide({ clientTitle, clientMonth, clientYear, onStart }) {
  return (
    <div className="slide-content cover-slide-container relative w-full h-full flex flex-col justify-between p-8 md:p-14 overflow-hidden select-none bg-white">
      {/* Decorative Vectors Faithful to PDF Page 1 */}

      {/* Top Left Squiggle */}
      <div className="decor-curves absolute -top-8 -left-8 w-44 h-44 pointer-events-none opacity-85">
      ...
      <div className="absolute top-10 left-32 hidden sm:flex items-center gap-3 pointer-events-none">
      ...
      {/* Right Side: Pen Tool */}
      <div className="decor-pen-tool absolute top-10 right-14 pointer-events-none">
      ...
      {/* Right Side: Architectural Arch with Dots */}
      <div className="decor-arch absolute top-28 right-8 pointer-events-none">
      ...
      {/* Main Center Area */}
      <div className="relative z-10 my-auto max-w-4xl py-4">
        ...
        <div className="flex items-center gap-3.5 mb-6">
          ...
          <div className="flex flex-col justify-center">
            <span className="text-[11px] md:text-xs font-black uppercase tracking-[0.2em] text-zinc-400">
              Agencia de Crecimiento Digital
            </span>
            <span className="text-2xl md:text-3xl font-black text-zinc-950 tracking-tight font-space leading-none mt-0.5">
        ...
        <div className="space-y-1">
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-zinc-950 uppercase tracking-tight font-space leading-tight">
            PRESENTACIÓN DE
          </h2>
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-orange-500 uppercase tracking-tighter font-space leading-none">
            PARRILLA
          </h1>
        </div>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3.5">
          <div className="px-5 py-2.5 bg-zinc-950 text-white font-bold rounded-2xl text-sm md:text-base tracking-wide uppercase shadow-lg shadow-zinc-900/10 flex items-center gap-2.5 border border-zinc-800">
            <Sparkles className="w-4 h-4 text-orange-400" />
            <span>{clientTitle || 'Sistemas Cuauhtli'}</span>
          </div>

          <div className="px-5 py-2.5 bg-orange-100/90 text-orange-700 font-extrabold rounded-2xl text-sm md:text-base tracking-wider uppercase border border-orange-200">
            {clientMonth || 'Septiembre'} {clientYear || '2026'}
          </div>

          <button
            onClick={onStart}
            className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold rounded-2xl text-sm md:text-base transition-all shadow-lg shadow-orange-500/25 flex items-center gap-2 cursor-pointer group hover:scale-[1.02] active:scale-[0.98]"
          >
      ...
      <div className="relative z-10 flex items-center justify-between text-xs font-semibold text-zinc-400 tracking-wider pt-4 border-t border-zinc-100">
        <div className="flex items-center gap-2">
          <span className="text-orange-500 font-black text-lg leading-none select-none">+</span>
          <span className="uppercase text-zinc-500 font-bold">Agencia de Crecimiento Digital</span>
        </div>

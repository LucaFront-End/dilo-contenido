...
export default function SlideDeck({
  ...
  return (
    <div className="slide-deck-wrapper flex flex-col items-center justify-start md:justify-center relative w-full min-h-screen bg-zinc-100 p-2 sm:p-4 md:p-6 pb-24 md:pb-6 overflow-y-auto md:overflow-hidden">
      ...
      <div className="slide-nav-bottom w-full max-w-[1500px] mt-3 md:mt-4 px-2 sm:px-4 flex items-center justify-between gap-2">
        {/* Left: Prev / Next Buttons */}
        <div className="flex items-center gap-1.5 sm:gap-2">
          <button
            onClick={prevSlide}
            disabled={currentSlideIndex === 0}
            className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-white hover:bg-zinc-50 text-zinc-800 border border-zinc-200 shadow-sm disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-1 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3 sm:px-5 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-orange-600 hover:bg-orange-500 text-white shadow-md shadow-orange-600/20 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-1 cursor-pointer"
          >
            <span>Siguiente</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className={`px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border shadow-sm ${
              approvalPercent === 100
